...
U64 RandState = 0UL; // The state can be seeded with any value
...
U64 ClockMS(void)
{
    ...
    return (U64)CurrentTime.tv_sec * 1000UL + (U64)CurrentTime.tv_usec / 1000UL;
}

/*
    Time in nanoseconds since midnight (00:00:00), January 1, 1970, coordinated universal time (UTC)
*/
U64 ClockNS(void)
{
    ...
    return (U64)CurrentTime.tv_sec * 1000000000UL + (U64)CurrentTime.tv_nsec;
}
...
//        printf("ThreadNumber = %d Node = %d Mask = 0x%016lx\n", ThreadNumber, Node, GroupAffinity.Mask);
